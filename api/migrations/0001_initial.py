# Generated by Django 3.1.6 on 2021-02-01 15:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('group', models.ForeignKey(blank=True, help_text='Выберите здесь название группы, к которой вы хотите отнести ваш пост!', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='posts', to='api.group', verbose_name='Группа постов')),
            ],
        ),
        migrations.CreateModel(
            name='Follow',
